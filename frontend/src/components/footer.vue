...
.patreon-link {
  & .image {
    filter: invert(94%) sepia(6%) saturate(590%) hue-rotate(339deg) brightness(109%) contrast(79%);
  }

  &:hover .image {
    filter: invert(39%) sepia(12%) saturate(4471%) hue-rotate(184deg) brightness(94%) contrast(89%);
  }
}
